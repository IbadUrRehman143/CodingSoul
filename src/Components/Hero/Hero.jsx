       ...
       <div className="container">
        <div className="row tw-items-center tw-gap-y-8 tw-pt-8">
            <div className="col-12 col-md-6">
                <h1 className='tw-font-extrabold tw-text-5xl md:tw-text-7xl tw-text-wh animate__animated animate__backInLeft'>Coding the Future Today</h1>
                <p className='tw-text-whi tw-text-xl tw-py-3 md:tw-text-2xl animate__animated animate__backInLeft'>Coding the Future Today
